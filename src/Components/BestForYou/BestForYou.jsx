    ...
    return (
        ...
        <div className="flex h-screen bg-[#F2F2F6] justify-between">
            <div className="flex justify-center items-center w-1/2">
                <img src={Bimg} alt=""  className="w-[82%] mt-[2%] ml-[15%]"/>
            </div>
               ...
               <p className="text-xl mt-5 text-[#2D2A6E]">The liber tempor cum soluta nobis eleifend option congue <br />
                ...
                <div className="container flex justify-between">
                    <div className="flex flex-col ">
                        ...
                        <h2 className="mt-4 text-[20px]">Apples, Berries & Cherries</h2>
                        <h1 className="border-b border-dotted border-blue-500  border-bold mt-4 py-2 text-[20px] font-medium">EXPIRY DATE:</h1>
                        <h2 className="mt-3 mb-3 text-[20px]">See on The Bottle Cap</h2>
                    ...
                    <div className="flex flex-col justify-start mr-[25%]">
                        <h1 className="border-b border-dotted border-blue-500  border-bold mt-4 py-2 text-[20px] font-medium">INGREDIENT:</h1>
                        <h2 className="mt-4 text-[20px]">Apples, Berries & Cherries</h2>
                        <h1 className="border-b border-dotted border-blue-500  border-bold mt-4 py-2 text-[20px] font-medium">BOOTLE SIZE:</h1>
                        <h2 className="mt-3 mb-3 text-[20px]">500ml – 1000ml</h2>
